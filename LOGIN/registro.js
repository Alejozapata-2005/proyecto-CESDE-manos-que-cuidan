...
document
  ...
  .addEventListener("submit", function (e) {
    ...
    if (!inputs.nombre.value) {
      ...
      inputs.nombre.parentElement.setAttribute(
        "data-error",
        "Nombre requerido"
      );
      hasError = true;
    ...
    if (!inputs.telefono.value) {
      ...
      inputs.telefono.parentElement.setAttribute(
        "data-error",
        "Teléfono requerido"
      );
      hasError = true;
    ...
    if (!inputs.direccion.value) {
      ...
      inputs.direccion.parentElement.setAttribute(
        "data-error",
        "Dirección requerida"
      );
      hasError = true;
    ...
    if (!inputs.password.value) {
      ...
      inputs.password.parentElement.setAttribute(
        "data-error",
    ...
    if (!inputs.rol.value) {
      ...
      inputs.rol.parentElement.setAttribute(
        "data-error",
    ...
    if (usuarios.find((u) => u.email === inputs.email.value)) {
      inputs.email.parentElement.classList.add("error");
      inputs.email.parentElement.setAttribute(
        "data-error",
